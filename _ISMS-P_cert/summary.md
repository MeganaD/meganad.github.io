...
- 최고책임자의 지정:[1.1.2](1.1.2)
  - CISO, CPO를 임원급으로 발령, 자격‧(ISMS필수인증 대상)신고 확인
- 조직 구성:[1.1.3](1.1.3)
  - 전문성 갖춘 실무조직, 임원급 위원회, 전사적 실무협의체 조직‧운영, 직무기술서‧조직도‧내부관리계획
- 범위 설정:[1.1.4](1.1.4)
...
#### 위험 관리:1.2
- 정보자산 식별:[1.2.1](1.2.1)
  - 분류기준 수립 및 정보자산 식별, 최신의 현황‧중요도‧보안등급 관리
...
- 운영현황 관리:[1.3.3](1.3.3)
  - 관리체계 운영 활동 기록‧관리, 주기적 경영진의 효과성 확인‧관리

#### 관리체계 점검 및 개선:1.4
- 법적 요구사항 준수 검토:[1.4.1](1.4.1)
  - 연 1회이상 준거성 검토, 정책의 최신성 유지
- 관리체계 점검:[1.4.2](1.4.2)
  - 독립적‧전문적 관리체계 점검계획 연 1회 이상 수립‧실시, 경영진 보고
- 관리체계 개선:[1.4.3](1.4.3)
...
- 정책의 유지관리:[2.1.1](2.1.1)
  - 중대한 환경 변화시 제‧개정, 정기적 타당성검토, 정책-시행문서 일관성 확보, 이력관리 및 이해 관계자 검토
- 조직의 유지관리:[2.1.2](2.1.2)
  - 담당자‧R&R 정의, 평가(MBO,KPI)‧소통 체계 수립‧운영 
- 정보자산 관리:[2.1.3](2.1.3)
...
- 직무 분리:[2.2.2](2.2.2)
  - SOD 수립‧적용, 불가능한 경우 상호검토, 승인, 로그, 모니터링 등 보완통제
- 보안 서약:[2.2.3](2.2.3)
...
- 외부자 계약 시 보안:[2.3.2](2.3.2)
  - RFP 및 평가에 보안역량을 반영, 보안요구사항 계약서에 명시, 외보‧목범재안감책
- 외부자 보안 이행 관리:[2.3.3](2.3.3)
  - 주기적인 보안 점검 등 관리‧감독 수행, 개선계획 수립‧이행
...
- 사용자 식별:[2.5.2](2.5.2)
  - 1인1계정, 기본ID처리, 쉬운ID제한, ID공유 승인‧보완통제 
- 사용자 인증:[2.5.3](2.5.3)
  - 인증절차(회시동경) 수립, 개처시 외부 접속 시 안전한 인증&접속수단 적용
- 비밀번호 관리:[2.5.4](2.5.4)
  - 규칙/관리절차 수립‧이행 (망-개취:2종10‧3종8,6개월,추측불가)
- 특수 계정 및 권한 관리:[2.5.5](2.5.5)
  - 별도 목록 관리, 신청/승인 절차 수립‧이행, 정기적 검토&최소화
- 접근권한 검토:[2.5.6](2.5.6)
  - 이력 보관(3‧5년), 분기1회 적정성 검토 & 조치절차 수립‧이행

#### 접근통제 :2.6
- 네트워크 접근:[2.6.1](2.6.1)
  - 접근경로 식별, 네트워크 영역 분리 & AC, 전송구간 보호대책 적용
- 정보시스템 접근:[2.6.2](2.6.2)
  - Host AC, 불필요 서비스‧포트 제거, 타임아웃, 서버 간 접속 통제
- 응용프로그램 접근:[2.6.3](2.6.3)
  - S/W AC, 권한 차등부여 및 정보노출 최소화(like 금지), 타임아웃‧동시접속 기준수립, 관리기능 접근제한
- 데이터베이스 접근:[2.6.4](2.6.4)
  - DB 내 정보 목록 현행화, AC 정책 수립‧이행
- 무선 네트워크 접근:[2.6.5](2.6.5)
  - wifi 인증&암호화, 신청‧해지 절차, rouge AP 통제(WIPS)
- 원격접근 통제:[2.6.6](2.6.6)
  - 원격운영 금지, 보완통제‧보호대책 수립‧이행, 개처시 관리용 단말기 지정‧관리‧보호조치
...
- 소스 프로그램 관리:[2.8.5](2.8.5)
  - AC, 운영환경이 아닌 곳에 안전하게 보관, 이력관리
- 운영환경 이관:[2.8.6](2.8.6)
  - 운영 이관 통제절차 수립‧이행, 필수 파일 만 설치

#### 시스템 및 서비스 운영관리:2.9
- 변경관리:[2.9.1](2.9.1)
  - IS관련 모든 자산의 변경내역 관리절차 수립‧이행, 영향분석
...
- 보안시스템 운영:[2.10.1](2.10.1)
  - 보안시스템 정책관리/운영 절차 수립‧이행, 타당성 주기적 검토, 엄격한 AC, 개처시 보안 확인 
...
- 개인정보의 수집 동의:[3.1.2](3.1.2)
  - 목항기‧거불, 중요내용 명확고지(연민고기제목,9‧20색볼밑),적시 수집, 만14대리인 확인‧미동의시 5일내 파기, 기록보관
...
- 영상정보처리기기 설치‧운영 :[3.1.6](3.1.6)
  - 법적 허용장소‧목적, 공청회, 안내판(목장범시관위), 운영‧관리‧보관방침 수립‧이행
...
- 개인정보 표시제한 및 이용 시 보호조치:[3.2.3](3.2.3)
  - 마스킹 표준 수립‧적용, 출력물 보호조치 및 검색 제한, 비식별 적정성 평가 & 모티터링
...
- 개인정보 제3자 제공:[3.3.1](3.3.1)
  - 법률 or 별도 동의, 제공 거부 가능, 명목항기거, 제공 최소화, 내역 기록‧보관
- 업무 위탁에 따른 정보주체 고지:[3.3.2](3.3.2)
  - 내용‧수탁자 공개, 홍보‧판매 위탁시 통지
...
- 정보주체 권리보장:[3.5.2](3.5.2)
  - 수집보다 쉬운 철회, 이용자 요구 10일내 처리‧기록, 이의제기 절차안내, 동의철회시 지체없이 파기, 타인권리침해 절차
- 이용내역 통지:[3.5.3](3.5.3)
  - 3개월평균100만명/전년도100억 연1회 수목항‧제목항 통지
