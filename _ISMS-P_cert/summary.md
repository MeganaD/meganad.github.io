...
- 접근권한 검토:[2.5.6](2.5.6)
  - 이력 보관(3ㆍ5년), 분기1회 적정성 검토 & 조치절차 수립ㆍ이행

#### 접근통제 :2.6
- 네트워크 접근:[2.6.1](2.6.1)
  - 접근경로 식별, 네트워크 영역 분리 & AC, 전송구간 보호대책 적용
- 정보시스템 접근:[2.6.2](2.6.2)
  - Host AC, 불필요 서비스ㆍ포트 제거, 타임아웃, 서버 간 접속 통제
- 응용프로그램 접근:[2.6.3](2.6.3)
  - S/W AC, 권한 차등부여 및 정보노출 최소화(like 금지), 타임아웃ㆍ동시접속 기준수립, 관리기능 접근제한
- 데이터베이스 접근:[2.6.4](2.6.4)
  - DB 내 정보 목록 현행화, AC 정책 수립ㆍ이행
...
- 인터넷 접속 통제:[2.6.7](2.6.7)
  - 주요 직무자ㆍ개처 업무단말 및 서버 인터넷 접속 통제 & 망분리(100만명, 100억원, 개처시 다ㆍ파ㆍ접)
...
- 보안시스템 운영:[2.10.1](2.10.1)
  - 보안시스템 정책관리/운영 절차 수립ㆍ이행, 타당성 주기적 검토, 엄격한 AC, 개처시 보안 확인 
...
- 보조저장매체 관리:[2.10.7](2.10.7)
  - 취급 정책 및 절차 수립ㆍ이행, 현황ㆍ실태 주기적 점검, 보호대책 & 안전한 보관
- 패치관리:[2.10.8](2.10.8)
...
- 취약점 점검 및 조치:[2.11.2](2.11.2)
  - 취약점 점검 절차 수립, 정기적 점검 & 보고, 영향분석ㆍ조치ㆍ재발방지
...
- 개인정보 표시제한 및 이용 시 보호조치:[3.2.3](3.2.3)
  - 마스킹 표준 수립ㆍ적용, 출력물 보호조치 및 검색 제한, 비식별 적정성 평가 & 모티터링
...
- 정보주체 권리보장:[3.5.2](3.5.2)
  - 수집보다 쉬운 철회, 이용자 요구 10일내 처리ㆍ기록, 이의제기 절차안내, 동의철회시 지체없이 파기, 타인권리침해 절차
- 이용내역 통지:[3.5.3](3.5.3)
